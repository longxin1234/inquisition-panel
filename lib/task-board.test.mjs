...
test("formats a running device as its name followed by token", () => {
  assert.equal(formatRunningDeviceLabel("A", "ksTUhCXGZMqPnNdn"), "设备A：ksTUhCXGZMqPnNdn")
  assert.equal(formatRunningDeviceLabel(" 2 ", "KAnlGTkYBcdnBwpO"), "设备2：KAnlGTkYBcdnBwpO")
  assert.equal(formatRunningDeviceLabel(null, "legacy-token"), "legacy-token")
})
...
test("labels scheduled and manual dispatch without labeling automatic work", () => {
